...
public class MainActivity extends AppCompatActivity implements CircleProgressBar.ProgressFormatter {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(view ->
            ...
            //달성률
            circleProgressBar_group =

            findViewById(R.id.circlebar_group);

            circleProgressBar_personal =

            findViewById(R.id.circlebar_personal);

            groupAchieveInfo =

            findViewById(R.id.groupAchieveInfo);

            personalAchieveInfo =

            findViewById(R.id.personalAchieveInfo);
            ...
            findViewById(R.id.achievementLayer);
